...
const Swiper = () => {
  const settings = {
    ...
    slidesToShow: 3,
    slidesToScroll: 3,
    // No need to define prevArrow and nextArrow explicitly
  };
  ...
  return (
    <div className="w-3/4 m-auto mb-24">
      <div className="mt-20">
        <Slider {...settings}>
          {Data.map((e) => (
            <div key={e.id} className="bg-[#2e303d] h-[300px] text-black rounded-xl">
              <div className="h-56 rounded-t-xl bg-[#2e303d] flex justify-center items-center">
                <img className="h-44 w-44" src={e.brand_logo} alt={e.brand_name} />
              </div>
